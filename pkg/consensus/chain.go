...
//判断当前区块的PrevBlock是否是bestChain的tip,Returns the result of adding data
...
func CheckNonce(nonceMp map[common.Address]uint64, bc blockchain.Blockchains, from *common.Address, txNonce uint64) bool {
	var nonce uint64
